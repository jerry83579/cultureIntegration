...
# print(len(z['initial_hum']))
# print(len(z['chebychev_temp']))
# print(len(z['chebychev_hum']))
# print(len(z['arima_temp']))
# print(len(z['arima_hum']))
# print(len(z['temp_tag']))
# print(len(z['hum_tag']))
# print('abc')


# if len(z['localtime'])==len(z['initial_temp'])==len(z['chebychev_temp'])==len(z['arima_temp'])==len(z['temp_tag']):
